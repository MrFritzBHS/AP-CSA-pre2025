...
0. **`printSquare(int[][] square)`**:
   - **Purpose**: Print each number in the magic square formatted into a square shape.
   - Use a 2D array traversal structure
     
2. **`getMagicNumber(int[][] square)`**:  
...
7. ***Challenge*** **`allNumbersUsed(int[][] square)`**:
